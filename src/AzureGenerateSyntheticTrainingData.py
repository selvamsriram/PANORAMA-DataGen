...
if __name__ == "__main__":
    ...
    parser.add_argument("--prompt-file", default="/Users/sriramselvam/Code/paraphrase_datagen/DataGeneration/Project/SyntheticSocialDataGenPrompt.md", help="Path to the system prompt file.")
